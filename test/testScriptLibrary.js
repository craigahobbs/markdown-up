...
test('script library, dataAggregate', () => {
    ...
    assert.deepEqual(markdownScriptFunctions.dataAggregate([data, aggregation], runtime.options), [
        {'a': 1, 'sum_b': 7},
        {'a': 2, 'sum_b': 5}
    ]);
});
...
test('script library, dataCalculatedField', () => {
    ...
    assert.deepEqual(markdownScriptFunctions.dataCalculatedField([data, 'c', 'a * b'], runtime.options), [
        {'a': 1, 'b': 3, 'c': 3},
        {'a': 1, 'b': 4, 'c': 4},
        {'a': 2, 'b': 5, 'c': 10}
    ]);
...
test('script library, dataCalculatedField variables', () => {
    ...
    const variables = {'d': 2};
    assert.deepEqual(markdownScriptFunctions.dataCalculatedField([data, 'c', 'b * d', variables], runtime.options), [
        {'a': 1, 'b': 3, 'c': 6},
        {'a': 1, 'b': 4, 'c': 8},
        {'a': 2, 'b': 5, 'c': 10}
    ]);
...
test('script library, dataCalculatedField globals', () => {
    ...
    assert.deepEqual(markdownScriptFunctions.dataCalculatedField([data, 'c', 'b * e'], runtime.options), [
        {'a': 1, 'b': 3, 'c': 9},
        {'a': 1, 'b': 4, 'c': 12},
        {'a': 2, 'b': 5, 'c': 15}
    ]);
...
test('script library, dataCalculatedField globals variables', () => {
    ...
    const variables = {'d': 2};
    assert.deepEqual(markdownScriptFunctions.dataCalculatedField([data, 'c', 'b * d * e', variables], runtime.options), [
        {'a': 1, 'b': 3, 'c': 18},
        {'a': 1, 'b': 4, 'c': 24},
        {'a': 2, 'b': 5, 'c': 30}
    ]);
...
test('script library, dataCalculatedField runtime', () => {
    ...
    assert.deepEqual(markdownScriptFunctions.dataCalculatedField([data, 'b', 'documentURL(a)'], runtime.options), [
        {'a': '/foo', 'b': '/foo'},
        {'a': 'bar', 'b': '/foo/bar'}
    ]);
});
...
test('script library, dataFilter', () => {
    ...
    assert.deepEqual(markdownScriptFunctions.dataFilter([data, 'b > 3'], runtime.options), [
        {'a': 1, 'b': 4},
        {'a': 2, 'b': 5}
    ]);
});
...
test('script library, dataFilter variables', () => {
    ...
    const variables = {'d': 3};
    assert.deepEqual(markdownScriptFunctions.dataFilter([data, 'b > d', variables], runtime.options), [
        {'a': 1, 'b': 4},
        {'a': 2, 'b': 5}
    ]);
});
...
test('script library, dataFilter globals', () => {
    ...
    assert.deepEqual(markdownScriptFunctions.dataFilter([data, 'a == c'], runtime.options), [
        {'a': 2, 'b': 5}
    ]);
});
...
test('script library, dataFilter globals variables', () => {
    ...
    const variables = {'d': 1};
    assert.deepEqual(markdownScriptFunctions.dataFilter([data, 'a == (c + d)', variables], runtime.options), [
        {'a': 2, 'b': 5}
    ]);
});
...
test('script library, dataFilter runtime', () => {
    ...
    assert.deepEqual(markdownScriptFunctions.dataFilter([data, 'documentURL(a) == "/foo/bar"'], runtime.options), [
        {'a': 'bar'}
    ]);
});
...
test('script library, dataJoin', () => {
    ...
    assert.deepEqual(markdownScriptFunctions.dataJoin([leftData, rightData, 'a'], runtime.options), [
        {'a': 1, 'b': 5, 'a2': 1, 'c': 10},
        {'a': 1, 'b': 6, 'a2': 1, 'c': 10},
        {'a': 2, 'b': 7, 'a2': 2, 'c': 11},
        {'a': 2, 'b': 7, 'a2': 2, 'c': 12},
...
test('script library, dataJoin globals', () => {
    ...
    assert.deepEqual(markdownScriptFunctions.dataJoin([leftData, rightData, 'a + e', 'b'], runtime.options), [
        {'a': 1, 'b': 2, 'c': 5, 'd': 11},
        {'a': 2, 'c': 6}
    ]);
});
...
test('script library, dataJoin globals variables', () => {
    ...
    const variables = {'f': 1};
    assert.deepEqual(markdownScriptFunctions.dataJoin([leftData, rightData, 'a + e + f', 'b', null, variables], runtime.options), [
        {'a': 1, 'b': 3, 'c': 5, 'd': 11},
        {'a': 2, 'c': 6}
    ]);
});
...
test('script library, dataJoin runtime', () => {
    ...
    assert.deepEqual(markdownScriptFunctions.dataJoin([leftData, rightData, 'documentURL(a)', 'b'], runtime.options), [
...
2,5
`;
    assert.deepEqual(markdownScriptFunctions.dataParseCSV([text, text2], runtime.options), [
        {'a': 1, 'b': 3},
        {'a': 1, 'b': 4},
        {'a': 2, 'b': 5}
    ]);
...
test('script library, dataSort', () => {
    ...
    assert.deepEqual(markdownScriptFunctions.dataSort([data, [['a', true], ['b']]], runtime.options), [
        {'a': 4, 'b': 7},
        {'a': 3, 'b': 6},
        {'a': 2, 'b': 5},
        {'a': 1, 'b': 3},
...
test('script library, dataTop', () => {
    ...
    assert.deepEqual(markdownScriptFunctions.dataTop([data, 3], runtime.options), [
        {'a': 1, 'b': 3},
        {'a': 1, 'b': 4},
        {'a': 2, 'b': 5}
    ]);
    assert.deepEqual(markdownScriptFunctions.dataTop([data, 1, ['a']], runtime.options), [
        {'a': 1, 'b': 3},
        {'a': 2, 'b': 5},
        {'a': 3, 'b': 6},
        {'a': 4, 'b': 7}
...
test('script library, dataValidate', () => {
    ...
    assert.deepEqual(markdownScriptFunctions.dataValidate([data], runtime.options), [
        {'a': '1', 'b': 3},
        {'a': '1', 'b': 4},
        {'a': '2', 'b': 5}
    ]);
