...
import {markdownElements as markdownModelElements, markdownHeaderId as markdownModelHeaderId} from 'markdown-model/lib/elements.js';
...
// $return: TODO
function markdownElements(args) {
    const [markdownModel] = valueArgsValidate(markdownElementsArgs, args);
    return markdownModelElements(markdownModel);
}
