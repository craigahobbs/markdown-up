...
export const pixelsPerPoint = 4 / 3;


// Helper function to flatten and line-split nested arrays of strings
export function flattenAndSplitLines(lines) {
...
export const markdownScriptFunctions = {
    ...
    'drawTextStyle': ([fontSizePx = null, textFill = 'black', bold = false, italic = false, fontFamily = defaultFontFamily], options) => (
