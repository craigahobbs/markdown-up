...
import {escapeMarkdownText, escapeMarkdownURL, escapeMarkdownURLComponent, markdownHeaderId} from 'markdown-model/lib/elements.js';
...
export const markdownScriptFunctions = {
    ...
    // $function: markdownEscapeText
    // $group: Markdown
    // $doc: Escape text for inclusion in Markdown text
    // $arg text: The text
    // $return: The escaped text
    'markdownEscapeText': ([text]) => escapeMarkdownText(text),

    // $function: markdownEscapeURL
    // $group: Markdown
    // $doc: Escape a URL for inclusion in a Markdown link
    // $arg url: The URL string
    // $return: The escaped URL string
    'markdownEscapeURL': ([url]) => escapeMarkdownURL(url),

    // $function: markdownEscapeURLComponent
    // $group: Markdown
    // $doc: Escape a URL component for inclusion in a Markdown link's URL
    // $arg urlComponent: The URL component string
    // $return: The escaped URL component string
    'markdownEscapeURLComponent': ([urlComponent]) => escapeMarkdownURLComponent(urlComponent),
