...
function documentElementClick(args, options) {
    const [id] = valueArgsValidate(documentElementClickArgs, args);
...
const documentElementClickArgs = valueArgsModel([
    {'name': 'id', 'type': 'string'}
]);
...
// $function: documentInputFileText
// $group: Document
// $doc: Read files as text from a file input element
// $arg id: The input element ID
// $return: The array of file text, or null if the element does not exist
async function documentInputFileText(args, options) {
    const [id] = valueArgsValidate(documentInputFileTextArgs, args);
    const element = options.window.document.getElementById(id) ?? null;
    if (element === null) {
        return null;
    }
    ...
    for (const file of element.files) {
        const reader = new options.window.FileReader();
...
const documentInputFileTextArgs = valueArgsModel([
    {'name': 'id', 'type': 'string'}
]);


// $function: documentInputFileURL
// $group: Document
// $doc: Read files as data URLs from a file input element
// $arg id: The input element ID
// $return: The array of file data URL strings, or null if the element does not exist
async function documentInputFileURL(args, options) {
    const [id] = valueArgsValidate(documentInputFileURLArgs, args);
    const element = options.window.document.getElementById(id) ?? null;
    if (element === null) {
        return null;
    }
...
const documentInputFileURLArgs = valueArgsModel([
    {'name': 'id', 'type': 'string'}
]);
...
export const markdownScriptFunctions = {
    dataLineChart,
    dataTable,
    documentElementClick,
    documentFontSize,
    documentInputFileText,
    documentInputFileURL,
    documentInputValue,
    documentSetFocus,
    documentSetReset,
    documentSetTitle,
