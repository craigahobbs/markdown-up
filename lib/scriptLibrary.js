...
import {escapeMarkdownLinkURL, escapeMarkdownText, markdownHeaderId} from 'markdown-model/lib/elements.js';
...
export const markdownScriptFunctions = {
    ...
    // $function: markdownEscapeLinkURL
    // $group: Markdown
    // $doc: Escape a URL for inclusion in a Markdown link
    // $arg text: The URL to escape
    // $return: The escaped URL
    'markdownEscapeLinkURL': ([url]) => escapeMarkdownLinkURL(url),
