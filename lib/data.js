 ...
 * @returns {Object[]} The unvalidated data array
 */
 ...
 * @param {?string} [rightExpr = null] - The right row's
 *     [join expression]{@link https://craigahobbs.github.io/calc-script/language/#expressions}
 * @param {boolean} [isLeftJoin = false] - If true, perform a left join (always include left row)
 * @param {?Object} [variables = null] - Additional variables for the join expressions
 ...
 * @returns {Object[]} data - The updated data array
 */
 ...
 *
 * @param {Object[]} data - The data array
 * @param {string} fieldName - The name of the field to aggregate
 * @param {string} [func = 'average'] - The aggregation function. Valid values are "average", "count", "max", "min", and "sum".
 * @param {?string[]} [categories = null] - The aggregation category field names
 * @param {?string} [aggregateName = null] - The aggregated field name. If null, "fieldName" is used.
 * @returns {Object[]} The aggregated data array
 */
export function aggregateData(data, fieldName, func = 'average', categories = null, aggregateName = null) {
    ...
    for (const row of data) {
        ...
        const field = aggregateName ?? fieldName;
        const value = row[fieldName] ?? null;
 ...
 * @returns {Object[]} data - The sorted data array
 */
