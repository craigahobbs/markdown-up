            ...
            // Table header
            {
                ...
                'elem': [
                    categories.map((field) => {
                        ...
                        return {
                            'html': 'th',
                            'attr': (fieldFormat !== null && 'align' in fieldFormat ? {'style': `text-align: ${fieldFormat.align}`} : null),
                            'elem': {'text': field}
                        };
                    }),
                    ...
                    'elem': [
                        categories.map((field) => {
                            ...
                            const fieldElements = fieldFormat !== null && fieldFormat.markdown
                                ...
                                : {'text': formatValue(value, formatPrecision, formatDatetime, false)};
                            return {
                                'html': 'td',
                                'attr': fieldFormat !== null && 'align' in fieldFormat
                                    ? {'style': `text-align: ${fieldFormat.align}`} : null,
