 ...
 * @property {string} [setNavigateTimeoutURL = null] The navigate timeout URL
 * @property {number} [setNavigateTimeoutDelay = null] The navigate timeout delay
...
export class MarkdownUp extends ElementApplication {
    ...
    async render() {
        ...
        // Was a runtime navigate timeout set?
        if (this.setNavigateTimeoutURL !== null) {
            const {setNavigateTimeoutURL, setNavigateTimeoutDelay} = this;
            const navigateFunc = () => {
                this.window.location.href = setNavigateTimeoutURL;
            };
            this.setNavigateTimeoutId = this.window.setTimeout(navigateFunc, setNavigateTimeoutDelay);
            this.setNavigateTimeoutURL = null;
            this.setNavigateTimeoutDelay = null;
        }
    }
    ...
    async main() {
        ...
        // The hash URL fixup function
        const hashFn = (hashURL) => {
        ...
        const runtime = new MarkdownScriptRuntime({fontSize, logFn});
        const chartOptions = {
            'fetchFn': this.window.fetch,
            fontSize,
            hashFn,
            runtime,
            url,
        ...
        // Was a runtime navigate timeout set?
        if (runtime.setNavigateTimeoutURL !== null) {
            this.setNavigateTimeoutURL = hashFn(runtime.setNavigateTimeoutURL);
            this.setNavigateTimeoutDelay = runtime.setNavigateTimeoutDelay;
        }
