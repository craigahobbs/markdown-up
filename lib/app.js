    ...
    async main() {
        ...
        const navigateTimeoutFn = (navigateURL, delay) => {
            const timeoutCallback = () => {
                this.window.location.href = (navigateURL.startsWith('#') ? hashFn(navigateURL) : navigateURL);
            };
        ...
        const runtimeOptions = {fontSize, logFn, navigateTimeoutFn};
        const runtime = new MarkdownScriptRuntime(runtimeOptions);
        const chartOptions = {
