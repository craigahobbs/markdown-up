...
export class MarkdownUp extends ElementApplication {
    ...
    async main() {
        ...
        if ('cmd' in this.params && 'help' in this.params.cmd) {
            if (this.params.cmd.help === 'Bar') {
                return {'elements': new UserTypeElements(this.params).getElements(chartModel.types, `BarChart`)};
            } else if (this.params.cmd.help === 'Line') {
                return {'elements': new UserTypeElements(this.params).getElements(chartModel.types, `LineChart`)};
            } else if (this.params.cmd.help === 'Table') {
                return {'elements': new UserTypeElements(this.params).getElements(chartModel.types, `DataTable`)};
            }
            return {'elements': new UserTypeElements(this.params).getElements(this.hashTypes, this.hashType)};
        }
