...
import {schemaMarkdownDoc, schemaMarkdownDocURLNote} from '../schema-markdown-doc/lib/schemaMarkdownDoc.js';
...
export class MarkdownScriptRuntime {
    ...
    constructor(options = null) {
        ...
        this.globals = {
            ...
            'schemaPrintURLNote': ([urls]) => this.schemaPrintURLNote(urls),
    ...
    schemaPrint(types, typeName, actionURLs = null) {
        const params = (
            this.options !== null && 'params' in this.options && this.params !== null ? encodeQueryString(this.options.params) : null
        );
        this.setElements(schemaMarkdownDoc(types, typeName, {params, actionURLs}));
    }

    schemaPrintURLNote(urls) {
        this.setElements(schemaMarkdownDocURLNote(urls));
    }
