 ...
 */
export function lineChartCodeBlock(codeBlock, options = null) {
    return chartCodeBlock(codeBlock, options, validateLineChart, lineChartElements);
}
...
export async function lineChartElements(lineChart, options = null) {
    ...
    const evalOptions = {'globals': variables};
    const computeExpr = (exprText, expectedType = null, desc = null) => {
        const exprValue = evaluateExpression(parseExpression(exprText), evalOptions);
