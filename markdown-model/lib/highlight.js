...
const highlightBuiltin = compileHighlightModels([
    ...
    // BareScript
    {
        ...
        'builtin': [
            createWordListRegex(
                'arrayCopy', 'arrayDelete', 'arrayExtend', 'arrayFlat', 'arrayGet', 'arrayIndexOf', 'arrayJoin',
                'arrayLastIndexOf', 'arrayLength', 'arrayNew', 'arrayNewSize', 'arrayPop', 'arrayPush', 'arraySet',
                'arrayShift', 'arraySlice', 'arraySort', 'baredocMain', 'coverageGlobalGet', 'coverageGlobalName',
                'coverageStart', 'coverageStop', 'dataAggregate', 'dataCalculatedField', 'dataFilter', 'dataJoin',
                'dataLineChart', 'dataParseCSV', 'dataSort', 'dataTable', 'dataTop', 'dataValidate', 'dataTableMarkdown',
                'datetimeDay', 'datetimeHour', 'datetimeISOFormat', 'datetimeISOParse', 'datetimeMillisecond',
                'datetimeMinute', 'datetimeMonth', 'datetimeNew', 'datetimeNow', 'datetimeSecond', 'datetimeToday',
                'datetimeYear', 'diffLines', 'documentFontSize', 'documentInputValue', 'documentSetFocus',
                'documentSetKeyDown', 'documentSetReset', 'documentSetTitle', 'documentURL', 'drawArc', 'drawCircle',
                ...
                'drawTextWidth', 'drawVLine', 'drawWidth', 'elementModelRender', 'formsLinkButtonElements',
                'formsLinkElements', 'formsTextElements', 'jsonParse', 'jsonStringify', 'localStorageClear',
                'localStorageGet', 'localStorageRemove', 'localStorageSet', 'markdownElements', 'markdownEscape',
                ...
                'objectKeys', 'objectNew', 'objectSet', 'pagerMain', 'pagerValidate', 'regexEscape', 'regexMatch',
                'regexMatchAll', 'regexNew', 'regexReplace', 'regexSplit', 'schemaDocMain', 'schemaDocMarkdown',
                'schemaParse', 'schemaParseEx', 'schemaTypeModel', 'schemaValidate', 'schemaValidateTypeModel',
                'sessionStorageClear', 'sessionStorageGet', 'sessionStorageRemove', 'sessionStorageSet',
                'stringCharCodeAt', 'stringEndsWith', 'stringFromCharCode', 'stringIndexOf', 'stringLastIndexOf',
                'stringLength', 'stringLower', 'stringNew', 'stringRepeat', 'stringReplace', 'stringSlice', 'stringSplit',
                'stringStartsWith', 'stringTrim', 'stringUpper', 'systemBoolean', 'systemCompare', 'systemFetch',
                'systemGlobalGet', 'systemGlobalIncludesGet', 'systemGlobalIncludesName', 'systemGlobalSet',
                'systemIs', 'systemLog', 'systemLogDebug', 'systemPartial', 'systemType', 'unittestDeepEqual',
                'unittestEqual', 'unittestReport', 'unittestRunTest', 'unittestMockAll', 'unittestMockEnd',
                'unittestMockOne', 'unittestMockOneGeneric', 'urlEncode', 'urlEncodeComponent', 'urlObjectCreate',
                'windowClipboardRead', 'windowClipboardWrite', 'windowHeight', 'windowSetLocation', 'windowSetResize',
                'windowSetTimeout', 'windowWidth', 'argsHelp', 'argsLink', 'argsParse', 'argsURL', 'argsValidate'
            )
        ],
        'comment': [rCommentHash],
        'keyword': [
